...
export const assignComplaint = async (req, res) => {
  ...
  try {
    ...
    const { complaint_id, assigned_employee_id, changed_by, remarks } =
      req.body;
...
export const updateComplaintAssignment = async (req, res) => {
  ...
  try {
    ...
    const old_status = statusCheck.rows[0].status;
...
`,
        [complaint_id, old_status, changed_by, remarks || "Reassigned"],
      );
    }
    await client.query("COMMIT");
